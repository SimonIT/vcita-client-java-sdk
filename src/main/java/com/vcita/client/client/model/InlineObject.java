...
public class InlineObject {
  ...
  private List<PortalsBusinessUidContactSubmitFormData> formData = null;

  public static final String SERIALIZED_NAME_SOURCE_DATA = "source_data";
  @SerializedName(SERIALIZED_NAME_SOURCE_DATA)
  private PortalsBusinessUidContactSubmitSourceData sourceData;

  public InlineObject() { 
  }

  public InlineObject formData(List<PortalsBusinessUidContactSubmitFormData> formData) {
    
    this.formData = formData;
    return this;
  }

  public InlineObject addFormDataItem(PortalsBusinessUidContactSubmitFormData formDataItem) {
  ...
  **/
  ...
  public List<PortalsBusinessUidContactSubmitFormData> getFormData() {
    return formData;
  }


  public void setFormData(List<PortalsBusinessUidContactSubmitFormData> formData) {
    this.formData = formData;
  }


  public InlineObject sourceData(PortalsBusinessUidContactSubmitSourceData sourceData) {
  ...
  **/
  ...
  public PortalsBusinessUidContactSubmitSourceData getSourceData() {
    return sourceData;
  }


  public void setSourceData(PortalsBusinessUidContactSubmitSourceData sourceData) {
    this.sourceData = sourceData;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.formData, inlineObject.formData) &&
        Objects.equals(this.sourceData, inlineObject.sourceData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formData, sourceData);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      JsonArray jsonArrayformData = jsonObj.getAsJsonArray("form_data");
      // validate the optional field `form_data` (array)
      if (jsonArrayformData != null) {
        for (int i = 0; i < jsonArrayformData.size(); i++) {
          PortalsBusinessUidContactSubmitFormData.validateJsonObject(jsonArrayformData.get(i).getAsJsonObject());
        };
      }
      // validate the optional field `source_data`
      if (jsonObj.getAsJsonObject("source_data") != null) {
        PortalsBusinessUidContactSubmitSourceData.validateJsonObject(jsonObj.getAsJsonObject("source_data"));
      }
  }
